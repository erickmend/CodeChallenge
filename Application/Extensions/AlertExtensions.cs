...
namespace Application.Extensions
{
    public static class AlertExtensions
    {
        ...
        public static IActionResult WithInfo(this IActionResult result, string title, string body, string buttonText)
        {
            return Alert(result, "info", title, body, buttonText);
        }

        public static IActionResult WithWarning(this IActionResult result, string title, string body, string buttonText)
        {
            return Alert(result, "warning", title, body, buttonText);
        }
